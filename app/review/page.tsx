      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Flashcards from across the curriculum. Rate yourself honestly — FSRS
            schedules the next look. Missed quiz items resurface here too.
          </p>
        </div>
        <Link
      ...
      {due.length > 0 ? (
        ...
        <Card className="mx-auto flex max-w-md flex-col items-center gap-3 py-14 text-center">
          ...
          <p className="max-w-xs text-sm text-muted-foreground">
            All {stats.total} cards are scheduled for later. Keep working through
            the roadmap to add more.
          </p>
        </Card>
      )}
    </div>
